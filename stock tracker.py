...
# ---------------------------------------------------------
# COLOR STYLES (for professional terminal UI)
# ---------------------------------------------------------
GREEN = "\033[92m"
RED = "\033[91m"
YELLOW = "\033[93m"
...
# ---------------------------------------------------------
# SECTION 1: REALISTIC STOCK DATABASE
# ---------------------------------------------------------
# Added company names, cost_price for P/L simulation
stock_data = {
...
# ---------------------------------------------------------
# FUNCTION: DISPLAY PORTFOLIO SUMMARY
# ---------------------------------------------------------
def show_summary():
    if not portfolio:
